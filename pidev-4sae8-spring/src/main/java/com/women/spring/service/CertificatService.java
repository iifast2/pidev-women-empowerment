...
import com.women.spring.repository.CertificatRepository;
...
//------------Export File----------------------------
    ...
    public void export(HttpServletResponse response,Long userId,Long FormationId ) throws IOException {
        ...
        String Nom="nom:"+userRepository.getById(userId).getNom();
        String Prenom="Prenom:"+userRepository.getById(userId).getPrenom();
